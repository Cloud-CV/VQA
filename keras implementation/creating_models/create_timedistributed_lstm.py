...
questions_model.add(LSTM(output_dim=quest_dim,input_shape=(SEQ_LENGTH,word_vec_dim),return_sequences=True))
# questions_model.add(LSTM(output_dim=quest_dim,input_shape=(SEQ_LENGTH,word_vec_dim),return_sequences=False))
...
open('C:/Users/ezio/Desktop/vqa/model/normal_1_gru_timedistributed_2hidden.json','w').write(name_model_mlp)
